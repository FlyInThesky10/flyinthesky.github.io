...
function(e) {
    ...
    function u(e, r, n, i) {
        ...
        try {
            ...
            for (_(r.substr(L)), k = x; k.parent; k = k.parent) k.cN && (M += "");
            return {
                r: B,
                value: M,
                language: e,
    ...
    function(e) {
        ...
        return {
            aliases: ["jsp"],
            k: r,
            i: /<\ 0="" |#="" ,="" c:="" [e.c("="" \\*\\*",="" "\\*="" ",="" {="" r:="" 0,="" [{="" b:="" \w+@="" },="" cn:="" "doctag",="" "@[a-za-z]+"="" }]="" }),="" e.clcm,="" e.cbcm,="" e.asm,="" e.qsm,="" "class",="" bk:="" "class="" interface",="" e:="" [{;="]/," ee:="" !0,="" k:="" i:="" [:"\[\]]="" "extends="" implements"="" e.utm]="" "new="" throw="" return="" else",="" "function",="" "("="" +="" t="" "\\s+)+"="" e.uir="" "\\s*\\(",="" rb:="" r,="" [e.utm]="" "params",="" \(="" \)="" [e.asm,="" e.cnm,="" e.cbcm]="" n,="" "meta",="" }="" e.registerlanguage("javascript",="" function(e)="" aliases:="" ["js"],="" keyword:="" "in="" of="" if="" for="" while="" finally="" var="" new="" function="" do="" void="" else="" break="" catch="" instanceof="" with="" case="" default try="" this="" switch="" continue="" typeof="" delete="" let="" yield="" const="" export="" super="" debugger="" as="" async await="" import="" from="" as",="" literal:="" "true="" false="" null="" undefined="" nan="" infinity",="" built_in:="" "eval="" isfinite="" isnan="" parsefloat="" parseint="" decodeuri="" decodeuricomponent="" encodeuri="" encodeuricomponent="" escape="" unescape="" object="" boolean="" error="" evalerror="" internalerror="" rangeerror="" referenceerror="" stopiteration="" syntaxerror="" typeerror="" urierror="" number="" math="" date="" string="" regexp="" array="" float32array="" float64array="" int16array="" int32array="" int8array="" uint16array="" uint32array="" uint8array="" uint8clampedarray="" arraybuffer="" dataview="" json="" intl="" arguments="" require="" module="" console="" window="" document="" symbol="" set="" map="" weakset="" weakmap="" proxy="" reflect="" promise"="" 10,="" ^\s*['"]use="" (strict|asm)['"]="" "string",="" "`",="" [e.be,="" "subst",="" "\\$\\{",="" "\\}"="" "number",="" v:="" "\\b(0[bb][01]+)"="" "\\b(0[oo][0-7]+)"="" e.cnr="" }],="" e.rsr="" "|\\b(case|return|throw)\\b)\\s*",="" "return="" case",="" [e.clcm,="" e.rm,="" <="">\s*[);\]]/,
                    r: 0,
                    sL: "xml"
                }],
                r: 0
    ...
    function(e) {
        ...
        return {
            ...
            },
            {
                ...
                c: [{
                    cN: "name",
                    b: /[^\/><\s]+ 0="" ,="" r:="" },="" a]="" }]="" }="" }),="" e.registerlanguage("markdown",="" function(e)="" {="" return="" aliases:="" ["md",="" "mkdown",="" "mkd"],="" c:="" [{="" cn:="" "section",="" v:="" b:="" "^#{1,6}",="" e:="" "$"="" "^.+?\\n[="-]{2,}$"" "<",="" "="">",
                sL: "xml",
                r: 0
            },
            {
    ...
    function(e) {
        ...
        return {
            ...
            c: [e.CLCM, e.HCM, e.C("/\\*", "\\*/", {
                ...
                cN: "string",
                b: /<<<['"]?\w+['"]?$ ,="" e:="" ^\w+;?$="" c:="" [e.be,="" {="" cn:="" "subst",="" v:="" [{="" b:="" \$\w+="" },="" \{\$="" \}="" }]="" r,="" t,="" (::|-="">)+[a-zA-Z_\x7f-\xff][a-zA-Z0-9_\x7f-\xff]*/
            },
            {
                cN: "function",
                bK: "function",
    ...
    function(e) {
        ...
        l = [c, n, {
            ...
            c: [e.inherit(e.TM, {
                ...
                b: "<\\s*", 0="" c:="" [{="" b:="" "("="" +="" e.ir="" "::)?"="" }]="" }].concat(i)="" },="" {="" cn:="" "function",="" bk:="" "def",="" e:="" "$|;",="" [e.inherit(e.tm,="" t="" }),="" o].concat(i)="" "symbol",="" e.uir="" "(\\!|\\?)?:",="" r:="" ":",="" [c,="" }],="" "number",="" "(\\b0[0-7_]+)|(\\b0x[0-9a-fa-f_]+)|(\\b[1-9][0-9_]*(\\.[0-9_]+)?)|[0_]\\b",="" "(\\$\\w)|((\\$|\\@\\@?)(\\w+))"="" e.rsr="" ")\\s*",="" [n,="" "regexp",="" [e.be,="" s],="" i:="" \n="" ,="" v:="" "="" ",="" [a-z]*"="" "%r{",="" "}[a-z]*"="" "%r\\(",="" "\\)[a-z]*"="" "%r!",="" "![a-z]*"="" "%r\\[",="" "\\][a-z]*"="" }].concat(i),="" }].concat(i);="" s.c="l," o.c="l;" var="" u="[>?]>" d="[\\w#]+\\(\\w+\\):\\d+:\\d+>" b="(\\w+-)?\\d+\\.\\d+\\.\\d(p\\d+)?[^>]+>" p="[{" ^\s*="">/,
            starts: {
                e: "$",
                c: l
            }
    ...
    e
});</\\s*",></",></",></=></|></\></['"]?\w+['"]?$></\?(php)?|\?></",></\s]+></\?\w+></script(?=\\s|></style(?=\\s|></\\!\\[cdata\\[",></\?(php)?(?!\w)></\></("></"></\s*<></|<<=|<=|<|===|==|=|></br[></[^></unnamed>